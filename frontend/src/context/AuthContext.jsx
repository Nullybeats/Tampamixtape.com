    ...
    try {
      const response = await fetch(`${API_URL}/api/auth/register`, {
        ...
        body: JSON.stringify({
          ...
          ...(userData.instagramUrl && { instagramUrl: userData.instagramUrl }),
          ...(userData.twitterUrl && { twitterUrl: userData.twitterUrl }),
          ...(userData.youtubeUrl && { youtubeUrl: userData.youtubeUrl }),
          ...(userData.tiktokUrl && { tiktokUrl: userData.tiktokUrl }),
          ...(userData.websiteUrl && { websiteUrl: userData.websiteUrl }),
